...
export const metadata = {
  title: "Aprovados pelo SISTEC-MEC | Colégio Simplifica Brasil",
  description:
    "O Colégio Simplifica Brasil possui registro e conformidade no SISTEC/MEC. Certificação oficial reconhecida, transparência e qualidade na diplomação.",
  openGraph: {
    title: "Aprovados pelo SISTEC-MEC | Colégio Simplifica Brasil",
    description:
...
export default function PageSistecMec() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#221968] via-[#2f277a] to-[#1a1445] text-white">
          ...
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-start">
            ...
            <div>
              ...
              <h1 className="mt-4 text-3xl sm:text-5xl font-extrabold leading-tight">
                Somos{" "}
                <span className="text-[#D4C8FF]">
                  Aprovados pelo SISTEC-MEC
                </span>
              </h1>
              <p className="mt-4 max-w-2xl text-white/80">
                Confiança que se comprova: o{" "}
                <strong className="text-white">Colégio Simplifica Brasil</strong> possui{" "}
              ...
              <ul className="mt-8 grid sm:grid-cols-2 gap-3 text-sm">
                {[
                  ...
                  >
                    <CheckCircle className="mt-0.5 h-5 w-5 text-[#D4AF37]" />
      ...
      {/* FAQ */}
      <section className="py-10 sm:py-14 bg-[#3C2E8F]">
      ...
      {/* CTA FINAL */}
      <section className="py-12 bg-[#261F63]">
        <div className="container mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center justify-between gap-4 rounded-3xl bg-[#3C2E8F] p-6 ring-1 ring-white/10 sm:flex-row">
            <p className="text-lg font-semibold">
              Pronto para validar sua formação com{" "}
              <span className="text-[#D4AF37]">Certificação Oficial</span>?
            </p>
    ...
    <svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
        <linearGradient id="g" x1="0" x2="1">
          ...
          <stop offset="100%" stopColor="#BFA136" />
        </linearGradient>
      </defs>
