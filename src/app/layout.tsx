...
export const metadata = {
  title:
    "Colégio Simplifica Brasil | Cursos Técnicos e Profissionalizantes Reconhecidos pelo MEC",
  description:
    "O Colégio Simplifica Brasil oferece cursos técnicos e profissionalizantes reconhecidos pelo MEC. Transforme seu futuro com educação técnica de excelência.",
  keywords: [
    "colégio simplifica brasil",
    "simplifica brasil",
    "cursos técnicos",
