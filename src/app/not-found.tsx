  ...
  return (
    <main className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-[#2f277a] via-[#4b3db8] to-black text-white overflow-hidden px-6">
      ...
      >
        <Link
          href="/"
          className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 rounded-xl font-semibold shadow-lg transition transform hover:-translate-y-1"
        >
