  ...
  const contacts = [
    {
      ...
      value: "(31) 97332-2570",
      href: "https://wa.me/31973322570", // link do WhatsApp
    },
    {
      icon: <Mail className="w-6 h-6 text-red-500" />,
      label: "E-mail",
      value: "Simplificabrasil.oficial@gmail.com",
      href: "mailto:Simplificabrasil.oficial@gmail.com",
    },
    {
      icon: <Instagram className="w-6 h-6 text-pink-500" />,
      label: "Instagram",
      value: "simplificabrasiltec.oficial",
