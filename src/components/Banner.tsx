...
const StatCard: FC<{ value: string; label: string }> = ({ value, label }) => (
  <div className="bg-white/10 rounded-lg p-6 text-center flex flex-col justify-center items-center backdrop-blur-sm">
    {/* A cor do valor agora é definida pelo container pai */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <Button
                size="lg"
                className="bg-[#F2960E] font-bold text-white hover:bg-[#F2960E]/90" // Ajustei o hover para escurecer levemente a cor principal
                asChild
              >
          ...
          {/* CORREÇÃO 2: A cor 'text-amber-500' foi trocada por 'text-[#F2960E]' */}
          <div className="grid grid-cols-2 gap-4 text-[#F2960E]">
