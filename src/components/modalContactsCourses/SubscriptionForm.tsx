    ...
    return (
      <div className="text-center p-8 flex flex-col items-center justify-center min-h-[450px]">
        ...
        <button
          ...
          className="group mt-8 w-full max-w-xs flex items-center justify-center gap-3 bg-primary text-primary-foreground px-6 py-3 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-[0_10px_30px_rgba(77,63,184,0.35)] hover:-translate-y-1"
        >
          <Send size={20} />
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full text-black px-4 py-3 rounded-xl border-slate-300 bg-white shadow-sm transition-colors duration-300 focus:border-primary focus:ring-2 focus:ring-primary/40"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={15}
            className="mt-1 block w-full px-4 py-3 text-black rounded-xl border-slate-300 bg-white shadow-sm transition-colors duration-300 focus:border-primary focus:ring-2 focus:ring-primary/40"
          />
        </div>
