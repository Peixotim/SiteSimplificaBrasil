    ...
    <>
      <section className="relative bg-gradient-to-r from-[#2f277a] via-[#4b3db8] to-[#1c1c1c] text-white py-20 px-6 md:px-12 overflow-hidden rounded-2xl shadow-lg max-w-7xl mx-auto my-16">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            <span className="uppercase text-sm tracking-widest text-[#e6e4ff] font-bold">
              Transforme seu Futuro
            </span>
            <h2 className="text-3xl md:text-4xl font-bold leading-tight">
              Conquiste Seu Curso <br />e Alcance{" "}
              <span className="text-[#e6e4ff]">Grandes Resultados</span>
            </h2>
            ...
            <div className="flex gap-4 mt-4">
              <a href="#cursos">
                <Button className="bg-primary text-primary-foreground font-bold px-6 py-3 rounded-xl shadow-lg hover:bg-primary/90 hover:scale-105 transition-transform">
