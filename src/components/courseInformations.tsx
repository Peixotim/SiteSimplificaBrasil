...
export default function CourseInformations({
  ...
  const WHATSAPP_NUMBER = "5531973322570";
      ...
      <div className="relative max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 z-10">
        ...
        <header className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          <div className="flex flex-col gap-4 pt-4">
            ...
            {cardData && cardData.rating > 0 && (
              <div className="flex items-center gap-2 text-[#e6e4ff] mt-2">
        ...
        <div className="mt-12 lg:mt-16 bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-[#E2E8F0] grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="md:col-span-2 flex flex-col items-center text-center">
            ...
            <button
              onClick={openModal}
              className="mt-6 w-full max-w-xs flex flex-col items-center justify-center gap-1 bg-primary text-primary-foreground p-4 rounded-lg font-bold text-lg transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-[0_10px_30px_rgba(77,63,184,0.35)]"
            >
              <div className="flex items-center gap-2">
                <CheckCircle size={22} className="text-[#e6e4ff]" />
